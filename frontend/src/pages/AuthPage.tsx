...
const registerSchema = z
  .object({
    ...
    company_address: z.string().min(3),
    company_phone: z.string().min(5),
...
export function LoginPage() {
  ...
  return (
    <AuthLayout
      title="Welcome back"
      subtitle="Sign in to your RetailPulse workspace"
    >
...
export function ForgotPasswordPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Enter your work email to request reset instructions."
    >
...
export function RegisterPage() {
  ...
  const submit = async (fields: RegisterFields) => {
    try {
      setError("");
  ...
  return (
    <AuthLayout
      ...
      subtitle="Set up your company and first administrator"
    >
      <form onSubmit={handleSubmit(submit)}>
        <Stack spacing={2}>
          {error && (
